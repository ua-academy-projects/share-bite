      ...
      <div className="relative flex min-h-screen items-center justify-center">
        <Card className="w-full max-w-md border-white/20 bg-[#03120d]/85 text-white shadow-[0_20px_70px_-30px_rgba(126,255,188,0.55)] backdrop-blur-md">
          <CardHeader className="space-y-3 pb-2 text-center">
            ...
            <CardDescription className="text-base text-slate-300">Sign in to Share Bite</CardDescription>
          </CardHeader>
          <CardContent className="pt-2">
            ...
            <div className="flex flex-col gap-3">
              <Button
                variant="outline"
                className="h-12 w-full rounded-xl border-white/35 bg-white/[0.03] text-base font-medium text-white hover:bg-white/10"
            ...
            <div className="mt-7 text-center text-sm text-slate-300">
              <Link to="/recover-access" className="font-medium text-[#98FF98] transition hover:text-[#b5ffb5] hover:underline">
                Forgot password?
              </Link>
              <span className="mx-2 text-slate-500">|</span>
              <Link to="/register" className="font-medium text-[#98FF98] transition hover:text-[#b5ffb5] hover:underline">
                Create account
              </Link>
            </div>
          </CardContent>
