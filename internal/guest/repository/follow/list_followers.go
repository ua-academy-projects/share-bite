...
func (r *Repository) ListFollowers(ctx context.Context, customerID string, cursorTime time.Time, cursorID string, limit int) ([]entity.Follower, error) {
	...
	q := database.Query{
		Name: "follow_repository.ListFollowers",
		Sql:  sql,
	}
