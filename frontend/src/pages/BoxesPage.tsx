...
import { AlertCircle, CheckCircle2, Filter, Loader2, RotateCcw, Search } from "lucide-react";
...
export function BoxesPage() {
  ...
  return (
    <PageLayout>
      ...
      {reserveError && (
        <div className="mb-6 flex items-start gap-3 rounded-2xl border border-red-500/30 bg-red-50 px-5 py-4 text-sm text-red-700 dark:bg-red-500/10 dark:text-red-300">
      ...
      {reserveSuccess && (
        <div className="mb-6 flex items-start gap-3 rounded-2xl border border-emerald-500/30 bg-emerald-50 px-5 py-4 text-sm text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-300">
